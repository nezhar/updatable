...
class TestUpdate(unittest.TestCase):
    ...
    def test_major_update_date(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(
                year=2015, month=9, day=29, hour=23, minute=34, second=21
            ),
        )
        self.assertEqual(
            updates["major_updates"][1]["upload_time"],
            datetime.datetime(
                year=2013, month=11, day=29, hour=23, minute=34, second=21
            ),
        )
    ...
    def test_minor_update_date(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(
                year=2014, month=9, day=29, hour=23, minute=34, second=21
            ),
        )
        self.assertEqual(
            updates["minor_updates"][2]["upload_time"],
            datetime.datetime(
                year=2013, month=10, day=29, hour=23, minute=34, second=21
            ),
        )
    ...
    def test_patch_update_date(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(
                year=2013, month=10, day=22, hour=23, minute=34, second=21
            ),
        )
        self.assertEqual(
            updates["patch_updates"][1]["upload_time"],
            datetime.datetime(
                year=2013, month=9, day=29, hour=23, minute=34, second=21
            ),
        )
